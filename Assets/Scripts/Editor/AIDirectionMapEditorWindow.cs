...
namespace EasyClick.Editor
{
    public class AIDirectionMapEditorWindow : EditorWindow
    {
        ...
        // Serialized EditorWindow properties
        ...
        // Serialized AIDirectionMap properties
        ...
        void CreateGUI()
        {
            ...
            _cleanMap = new Button(ClearMaps)
            {
                text = "Clean Map"
            };
        ...
        void Rectangulate()
        {
            ...
            // Move rectangular map directions to unrectangulated map
        ...
        void SetDirectionToProperty(Vector2Int coords, Vector2 direction)
        {
            ...
            {
                // Save direction to rectangular map
            ...
            {
                // Save direction to unrectangluated map
                for (int i = 0; i < _serilaizedMapProp.arraySize; i++)
                {
                    var coordsProp = _serilaizedMapProp.GetArrayElementAtIndex(i).FindPropertyRelative("Coords");
